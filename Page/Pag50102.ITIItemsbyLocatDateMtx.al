page 50102 "ITI Items by Loc. at Date Mtx"
{
    ...
    begin
        ...
        TempItem.CalcFields("Inventory at Date");
        MATRIX_CellData[ColumnID] := TempItem."Inventory at Date";
        SetVisible;
    end;
    ...
    procedure SetPostingDateFilter(pDateFilter: text)
    begin
