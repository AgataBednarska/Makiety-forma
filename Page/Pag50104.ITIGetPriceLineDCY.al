page 50104 "ITI Get Price Line DCY"
{
    ...
    begin
        ...
        IsSalesPrice := PriceType.AsInteger() = Rec."Price Type"::Sale.AsInteger();
    ...
    procedure SetCurrency(CurrencyCode: Code[20]; CurrDate: Date)
    begin
